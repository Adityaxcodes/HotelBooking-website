        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="flex items-center bg-white rounded-2xl shadow-md p-6 gap-6">
            ...
            <div>
              ...
              <p className="text-2xl font-bold text-gray-900">{loading ? '...' : totalBookings}</p>
            </div>
          </div>
          {/* Total Revenue Card */}
          <div className="flex items-center bg-white rounded-2xl shadow-md p-6 gap-6">
            ...
            <div>
              ...
              <p className="text-2xl font-bold text-gray-900">{loading ? '...' : `${currency}${totalRevenue}`}</p>
            </div>
          </div>
